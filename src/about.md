...
Andrew is the creator of **bytefreq**, originally written in awk in 2007 and now reimplemented in Rust, and **DataRadar**, a browser-based WASM profiler for locked-down environments where installing software is not possible. His current work at **Zenkai Laboratories** focuses on data operating model design, data platform architecture, and AI strategy.

He believes that data quality should not require a PhD or an enterprise licence — just a clear idea and a good tool.

- GitHub: [github.com/minkymorgan](https://github.com/minkymorgan)
